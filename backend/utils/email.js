...
const shell = (title, intro, order, footer) => `
  <div style="font-family:Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a;">
    ...
    <p style="font-size:14px;color:#555;">Payment method: <strong>${order.paymentMethod}</strong> · ${order.isPaid ? "Paid" : order.paymentMethod === "COD" ? "Cash on delivery" : "Awaiting payment"}</p>
